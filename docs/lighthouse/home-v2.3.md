# Lighthouse · home-v2.3

Ejecutado: 2026-05-09T21:51:29.385Z
...
|---|---|---|
| LCP (Largest Contentful Paint) | 2.9 s | 0.8 s |
| FCP (First Contentful Paint)   | 1.4 s   | 0.4 s   |
| TBT (Total Blocking Time)      | 130 ms      | 0 ms      |
| CLS (Cumulative Layout Shift)  | 0  | 0  |
| Speed Index                    | 2.5 s              | 0.5 s              |
| TTI (Time to Interactive)      | 2.9 s              | 0.8 s              |
